...
fn main(){
    ...
    println!("cargo:rustc-link-search=native=/usr/local/genome/hdf5-1.10.6/hdf5/lib");
    println!("cargo:rustc-link-search=native=/usr/local/lib");
    println!("cargo:rustc-link-search=native=/usr/lib64/boost169");
    ...
    cc::Build::new()
        ...
        .include("/usr/local/genome/hdf5-1.10.6/hdf5/include")
        .compile("libfast5.a");
